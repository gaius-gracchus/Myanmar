...
"""Create interactive visualization of graph for network of corporations
...
INPUT_EDGES_DF = '../output/corporations_edges.pkl'

# GEXF file generated bu Gephi
INPUT_GEXF = '../output/corporations_graph_layout.gexf'

NODES_ATTRIBUTES_DF = '../output/corporations_attributes.pkl'

# File to save visualization to (without `.html` extension)
OUTPUT_HTML = '../visualizations/corporation_graph'
...
# Define conversion dict between corporation ID and node index
corpid_to_idx = dict( zip( nodes_df[ 'corp_id' ], nodes_df[ 'index'] ) )
...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
# Incorporate attribute information about each company
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
...
nodes_attributes_df.rename(
  columns = { 'CorpId' : 'corp_id'}, inplace = True )

# Merge node attributes with nodes dataframe
nodes_df = nodes_df.merge( nodes_attributes_df, how = 'left', on = 'corp_id', )
...
edges_df[ 'source' ] = edges_df[ 'source' ].map( corpid_to_idx )
edges_df[ 'target' ] = edges_df[ 'target' ].map( corpid_to_idx )
